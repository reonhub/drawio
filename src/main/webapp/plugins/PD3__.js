...
Sidebar.prototype.addProblemSolvingLayerPalette = function (expand) {
  ...
  this.addEntry('Engineering Cycle', function () {
    ...
    this.createVertexTemplateEntry(
      "rounded=0;whiteSpace=wrap;html=1;pd3layer=topic;pd3type=object;strokeColor=#d79b00;dashed=1;fontSize=14;fillColor=none;dashPattern=1 1;strokeWidth=2;",
      object_width,
      object_height,
      "Object",
      "Object",
...
Sidebar.prototype.addInformationLayerPalette = function (expand) {
  ...
  var fns = [
    ...
    this.createVertexTemplateEntry(
      "rounded=0;whiteSpace=wrap;html=1;pd3layer=info;pd3type=object;strokeColor=#6c8ebf;dashed=1;fontSize=14;fillColor=none;strokeWidth=2;dashPattern=1 1;",
      object_width,
      object_height,
      "Object",
      "Object",
...
Sidebar.prototype.addPhysicalLayerPalette = function (expand) {
  ...
  var fns = [
    ...
    this.createVertexTemplateEntry(
      "rounded=0;whiteSpace=wrap;html=1;pd3layer=phys;pd3type=object;strokeColor=#82b366;dashed=1;dashPattern=1 1;fontSize=14;strokeWidth=2;fillColor=none;",
      object_width,
      object_height,
      "Object",
      "Object",
...
Actions.prototype.init = function () {
  ...
  this.addAction("editURI", mxUtils.bind(this, function () {
    ...
    root_style = setURIArray(root_style);
    if(root_style!=null){
      if("thisURI" in root_style){
        var URI_val = root_style["thisURI"];
      }else{
        URI_val = "";
      }
    }else{
...
(function () {
  ...
  DiagramFormatPanel.prototype.addStyleOps = function (a) {
    ...
    div1.className= "ep_uri_div";
    div1.style.display= "table";
    div1.style.marginBottom="4px";
    div1.style.wordBreak="break-all";
    div1.style.color = "rgb(37 37 37)";
    div1.style.fontSize = "15px";
    mxUtils.setTextContent(div1,"For This EP Description");
    a.appendChild(div1);
    ...
    EP_URI_div.style.marginBottom="2px";
    ...
    EP_URI_prefix_div.style.marginBottom="2px";
  ...
  function setStyleArray (mxCell){
    ...
    style_return = setURIArray(style_return);
    return style_return;
  ...
  function setURIArray (styleArray){
    if(styleArray != null){
      if("thisURI" in styleArray){
        styleArray["thisURI"] = styleArray["thisURI"].trim().replaceAll("[","").replaceAll("]","").split(",");
      }
      if("otherURIs" in styleArray){
        var tmpArray = styleArray["otherURIs"].trim().replaceAll("[","").replaceAll("]","").split(",");
        var otherURIs = new Array(tmpArray.length/2);
        for(let i = 0; i < otherURIs.length; i++) {
          otherURIs[i] = new Array(2).fill(null);
        }
        for (var i=0; i < tmpArray.length; i = i + 2){
            otherURIs[i/2][0] = tmpArray[i];
            otherURIs[i/2][1] = tmpArray[i+1];
        }
        styleArray["otherURIs"] = otherURIs;
      }
    }
  ...
  StyleFormatPanel.prototype.init = function () {
    ...
    a = this.format.getSelectionState();
...
DiagramFormatPanel.prototype.init = function () {
  ...
  // this.container.appendChild(this.addOptions(this.createPanel())), 
  // this.container.appendChild(this.addPaperSize(this.createPanel())), 
  this.container.appendChild(this.addThisInfo(this.createPanel())),
  this.container.appendChild(this.addOthersInfo(this.createPanel()))

)};

DiagramFormatPanel.prototype.addThisInfo = function (a) {
    a.style.fontSize ="14px";
    root = this.editorUi.editor.graph.getModel().root;
    root_style = setStyleArray(root);
    if(root_style!=null){
      if("thisURI" in root_style){
        URI_val = root_style["thisURI"][0];
        prefix_val = root_style["thisURI"][1];
      }else{
        URI_val = "";
        prefix_val = "";
      }
    ...
    div1.style.color = "rgb(37 37 37)";
    div1.style.fontSize = "15px";
    mxUtils.setTextContent(div1,"For Other EP Descriptions");
    a.appendChild(div1);
    ...
    EP_URI_prefix_div.className= "ep_uri_prefix_div";
    EP_URI_prefix_div.style.display= "table";
    EP_URI_prefix_div.style.marginBottom="6px";
    EP_URI_prefix_div.style.wordBreak="break-all";
  ...
  DiagramFormatPanel.prototype.addOthersInfo = function (a) {
    a.style.fontSize ="14px";
    root = this.editorUi.editor.graph.getModel().root;
    root_style = setStyleArray(root);
    if(root_style!=null){
