...
(function()
{
	...
	if (window.StyleFormatPanel != null)
	{
		...
		StyleFormatPanel.prototype.defaultColorSchemes = [[{fill: '', stroke: ''}, {fill: '#f5f5f5', stroke: '#666666', font: '#333333'},
			...
			{fill: '#008a00', stroke: '#005700', font: '#ffffff'}, {fill: '#2EBAC9', stroke: '#006EAF', font: '#ffffff'},
			{fill: '#3E54E6', stroke: '#001DBC', font: '#ffffff'}, {fill: '#6a00ff', stroke: '#3700CC', font: '#ffffff'},
			//{fill: '#aa00ff', stroke: '#7700CC', font: '#ffffff'},
			{fill: '#C93AC9', stroke: '#A50040', font: '#ffffff'}, {fill: '#8F4132', stroke: '#6F0000', font: '#ffffff'}],
			[{fill: '#e51400', stroke: '#B20000', font: '#ffffff'}, {fill: '#fa6800', stroke: '#C73500', font: '#ffffff'},
			{fill: '#f0a30a', stroke: '#BD7000', font: '#ffffff'}, {fill: '#D1BC35', stroke: '#B09500', font: '#ffffff'},
